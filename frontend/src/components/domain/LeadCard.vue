  ...
  >
    ...
    <div class="flex items-start justify-between mb-3">
      <div class="flex items-center space-x-2 flex-1 min-w-0">
        ...
        <!-- Name -->
        <h4 class="font-semibold text-black truncate">{{ lead.name }}</h4>
      </div>
    </div>

    <!-- Phone -->
    <div v-if="lead.phone" class="text-sm text-gray-600 mb-2">
      {{ lead.phone }}
    </div>

    <!-- First message -->
    <div v-if="lead.first_message" class="text-sm text-gray-600 mb-3 line-clamp-2">
      {{ lead.first_message }}
    </div>
